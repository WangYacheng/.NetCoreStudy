...
namespace Dang.Common.Files {
    ...
    public struct FileSize {
        ...
        public double GetSizeByK() {
            return Dang.Common.Helpers.Convert.ToDouble( _size / 1024.0, 2 );
        }
        ...
        public double GetSizeByM() {
            return Dang.Common.Helpers.Convert.ToDouble( _size / 1024.0 / 1024.0, 2 );
        }
        ...
        public double GetSizeByG() {
            return Dang.Common.Helpers.Convert.ToDouble( _size / 1024.0 / 1024.0 / 1024.0, 2 );
        }
