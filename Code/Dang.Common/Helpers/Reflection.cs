...
namespace Dang.Common.Helpers {
    ...
    public static class Reflection {
        ...
        public static T CreateInstance<T>( Type type, params object[] parameters ) {
            return Dang.Common.Helpers.Convert.To<T>( Activator.CreateInstance( type, parameters ) );
        }
        ...
        public static string GetDefaultValue(Type type, string memberName)
        {
            if (type == null)
                return string.Empty;
            if (string.IsNullOrWhiteSpace(memberName))
                return string.Empty;
            return GetDefaultValue(type.GetTypeInfo().GetMember(memberName).FirstOrDefault());
        }
        ...
        public static string GetDefaultValue(MemberInfo member)
        {
            if (member == null)
                return string.Empty;
            return member.GetCustomAttribute<DefaultValueAttribute>() is DefaultValueAttribute attribute
