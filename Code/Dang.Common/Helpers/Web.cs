...
using System.Web;
using Dang.Common.Security.Principals;
...
namespace Dang.Common.Helpers
{
    ...
    public static class Web
    {
        ...
        public static IHttpContextAccessor HttpContextAccessor
        {
            get
            {
                return MyServiceProvider.ServiceProvider.GetRequiredService<IHttpContextAccessor>();
            }
        }
        ...
        public static IHostingEnvironment Environment
        {
            get
            {
                return MyServiceProvider.ServiceProvider.GetRequiredService<IHostingEnvironment>();
            }
        }
        ...
        public static int UserId
        {
            get
            {
                try
                {
                    return Identity.Claims.SingleOrDefault(s => s.Type == "id").Value.ToInt();
                }
                catch
                {
                    return 0;
        ...
        public static string UserName
        {
            get
            {
                return Identity.Claims.SingleOrDefault(s => s.Type == ClaimTypes.Name).Value;
            }
        }
        ...
        /// Web客户端，用于发送Http请求
        /// </summary>
        public static Dang.Common.Webs.Clients.WebClient Client()
        {
            return new Dang.Common.Webs.Clients.WebClient();
        }
        ...
        public static Dang.Common.Webs.Clients.WebClient<TResult> Client<TResult>() where TResult : class
        {
            return new Dang.Common.Webs.Clients.WebClient<TResult>();
        }
