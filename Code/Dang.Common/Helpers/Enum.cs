...
namespace Dang.Common.Helpers {
    ...
    public static class Enum {
        ...
        private static void AddItem(Type type, ICollection<Item> result, FieldInfo field)
        {
            ...
            var defaultValue = Reflection.GetDefaultValue(field);
            result.Add(new Item(description, value, value, defaultValue));
        }
        ...
        public static string GetDefaultValue(Type type, object member)
        {
            return Reflection.GetDefaultValue(type, GetName(type, member));
        }
    }
}
