...
namespace Dang.Common.Helpers
{
    ...
    {
        const string base64Pre = "data:image/png;base64,";

        public static string Letters { get; set; } = "0123456789";
        ...
        public static CaptchaResult GetImage(int width, int height, string captchaCode, bool drawBezier = false)
        {
            ...
            using (var graph = Graphics.FromImage(baseMap))
            {
                ...
                int GetFontSize(int imageWidth, int captchCodeCount)
                {
                    ...
                    return System.Convert.ToInt32(averageSize);
                }

                Color GetRandomDeepColor()//字体色
                {
                    //return Color.FromArgb(46, 94, 233);
                    int redlow = 160, greenLow = 100, blueLow = 160;
                    return Color.FromArgb(rand.Next(redlow), rand.Next(greenLow), rand.Next(blueLow));
                }

                Color GetRandomLightColor()//背景色
                {
                    ...
                    return Color.FromArgb(255, 255, 255);//(nRend, nGreen, nBlue);
                }
    ...
    public class CaptchaResult
    {
        ...
        public string CaptchBase64Data => System.Convert.ToBase64String(CaptchaByteData);
