...
namespace Dang.Infrastruct.DB
{
    public interface ISqlHelper
    {
        ...
        System.Data.DataTable Query(string sqlText, CommandType commandType = CommandType.Text, params IDbDataParameter[] parms);
        ...
        /// <param name="commandType">命令类型</param>
        /// <returns>返回泛型的实体对象</returns>
        System.Data.DataTable Query(string sqlText, Func<IDbDataParameter[]> func, CommandType commandType = CommandType.Text);
        ...
        int Execute(string sqlText, CommandType commandType = CommandType.Text, IDbTransaction trans = null, params IDbDataParameter[] parms);
        ...
        /// <param name="commandType">命令类型</param>
        /// <returns></returns>
        int Execute(string sqlText, Func<IDbDataParameter[]> func, CommandType commandType = CommandType.Text, IDbTransaction trans = null);
    }
}
