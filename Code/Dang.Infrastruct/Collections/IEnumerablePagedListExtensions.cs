...
namespace Dang.Infrastruct.Collections
{
    /// <summary>
    ...
    public static class IEnumerablePagedListExtensions
    {
        ...
        /// <param name="needPage">The start index value.</param>
        /// <param name="totalCount">The start index value.</param>
        /// <returns>An instance of the inherited from <see cref="IPagedList{T}"/> interface.</returns>
        public static IPagedList<T> ToPagedList<T>(this IEnumerable<T> source, int pageIndex, int pageSize, int indexFrom = 0, bool needPage = true, int totalCount = 0) => new PagedList<T>(source, pageIndex, pageSize, indexFrom, needPage, totalCount);
